...
2009-01-18
* Yhdenmukaisettu "selite"-sanan käyttö kaikkialle ja
  korjattu lisää virheitä
...
class TranslatorFinnish : public Translator
{
  public:
    ...
    virtual QCString trFileListDescription(bool extractAll)
    {
      ...
      result+="tiedostoista lyhyiden selitteiden kanssa:"; // "files with brief descriptions:"
      return result;
    }
    ...
    virtual QCString trCompoundListDescription()
    {
      ...
      if (Config_getBool("OPTIMIZE_OUTPUT_FOR_C"))
      {
        return "Tässä ovat tietueet lyhyiden selitteiden kanssa:"; // "Here are the data structures with brief descriptions:"
      }
      else
      {
        return "Tässä ovat luokat, tietueet ja " // "Here are the classes, structs and "
             "yhdisteet lyhyiden selitteiden kanssa:"; // "unions with brief descriptions:"
      }
    }
    ...
    { 
      ...
      QCString result=(QCString)"Luonut ";
...
//////////////////////////////////////////////////////////////////////////
    ...
    virtual QCString trNamespaceListDescription(bool extractAll)
    {
      QCString result="Tässä on lista kaikista "; // "Here is a list of all "
      if (!extractAll) result+="dokumentoiduista "; // "documented "
      result+="nimiavaruuksista lyhyiden selitteiden kanssa:"; // "namespaces with brief descriptions:"
      return result;
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Rakentajien ja purkajien dokumentaatio"; // "Constructor & Destructor Documentation";
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return 
        "Tämä sivu kertoo, kuinka doxygenin luomia kaavioita tulkitaan.<p>\n"
...
//////////////////////////////////////////////////////////////////////////
    ...
    {
      return "Tässä ovat paketit lyhyiden selitteiden kanssa (jos saatavilla):"; // "Here are the packages with brief descriptions (if available):"
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { return "Tässä ovat tietotyypit lyhyiden selitteiden kanssa:"; } // "Here are the data types with brief descriptions:"
    ...
    virtual QCString trCompoundMembersDescriptionFortran(bool extractAll)
    {
      ...
      if (!extractAll) 
      {
         result+="tietueen dokumentaatioon kullekin jäsenelle"; // "the data structure documentation for each member"
      }
      else 
      {
    ...
    virtual QCString trModulesListDescription(bool extractAll)
    {
      QCString result="Tässä on lista kaikista "; // "Here is a list of all "
      if (!extractAll) result+="dokumentoiduista "; // "documented "
      result+="moduuleista lyhyiden selitteiden kanssa:"; // "modules with brief descriptions:"
      return result;
    }
